...
type THerlpers4DDateTime = record helper for TDateTime
...
function THerlpers4DDateTime.DateTimeToIso8601: string;
begin
  if Self = 0 then
    Result := ''
  else
...
function THerlpers4DDateTime.Format(ADateFormat: String): String;
begin
  result := FormatDateTime(ADateFormat, Self);
end;

function THerlpers4DDateTime.FormatYYYY_MM_DD: string;
begin
